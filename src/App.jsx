const projects = [
  {
    ...
    description:
      "An AI-powered music discovery app. Describe any mood, vibe, or artist and get 25 real tracks back, ranked by listener data from millions of people. Built with Groq's Llama 3.3 70B for mood analysis, Last.fm for tag-based discovery, and Spotify for enrichment and playlist saving. Connect your Spotify account to save results directly as a playlist.",
