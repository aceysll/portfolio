...
const projects = [
  ...
  },
  {
    ...
    description: "Browser-based video reshuffler. Upload any video, pick a clip length, and it chops the footage into segments, randomises the order, and stitches a new video ready for download. All processing runs entirely client-side via FFmpeg.wasm. No uploads, no server, no waiting.",
...
function AnimatedCard({ project, index, globalDelay }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        transition: `opacity 0.6s ease ${globalDelay + index * 0.1}s, transform 0.6s ease ${globalDelay + index * 0.1}s`,
      }}
    >
      <div
      ...
      >
        ...
        <div
          onClick={handleClick}
          style={{ padding: "36px 40px", display: "flex", gap: 40, alignItems: "flex-start" }}
        >
          {/* Index */}
          <div style={{ flexShrink: 0, width: 48, paddingTop: 4 }}>
            <div style={{ fontSize: 11, fontWeight: 600, color: "#bbb", letterSpacing: "0.08em", fontFamily: "'Inter', sans-serif" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 5, alignItems: "center" }}>
              ...
              <span style={{ marginLeft: "auto", fontSize: 16, color: hovered || expanded ? "#111" : "#ccc", transition: "color 0.2s, transform 0.2s", display: "inline-block", transform: hovered && !expanded ? "translate(2px, -2px)" : expanded ? "rotate(90deg)" : "none" }}>
                {expanded ? "↓" : "↗"}
              </span>
            </div>
          </div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <header style={{ padding: "72px 40px 56px" }}>
          <div style={{
            ...
            <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "#aaa", marginBottom: 20 }}>
              Ace — aceysll
            </div>
          </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: 15, color: "#777", lineHeight: 1.75, maxWidth: 440, fontWeight: 400 }}>
              A set of live, working tools. Each one started from a genuine need
              and was built until it was actually useful.
            </p>
          </div>
        </header>
        ...
        <main>
          ...
          {projects.map((project, i) => (
            <AnimatedCard key={project.id} project={project} index={i} globalDelay={0.1} />
          ))}
        ...
        <footer style={{ padding: "32px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 20 }}>
            ...
            <a href="mailto:dharnyel22@gmail.com"
              style={{ fontSize: 12, color: "#999", transition: "color 0.15s" }}
              onMouseEnter={e => e.target.style.color = "#111"}
              onMouseLeave={e => e.target.style.color = "#999"}>
              Email
